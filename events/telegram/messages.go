...
const (
	msgUnknownCommand     = "🤔 I don`t know this command. \nUse /help or /menu to get a list of commands."
	msgNoSavedPages       = "📭 You have no saved pages!"
	msgSaved              = "✅ This page was saved!"
	msgAlreadyExists      = "⚠️ You already have this page in your list"
	msgCount              = "📊 You have this count of pages: "
	msgList               = "📚 You already saved these pages: "
	msgQuery              = "🔍 This is result of search: "
